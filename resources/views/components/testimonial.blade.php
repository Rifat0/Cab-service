        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="section-heading mb-10">
                    ...
                    <h2>Short pump cab Passenger Reviews...</h2>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-item">
                                    ...
                                    <div class="testi-author">
                                        <div class="author-thumb"><img src="{{ asset('/') }}img/comment-1.png" alt="author">
                                        </div>
            ...
            <div class="col-lg-6">
                <div class="feature-wrap">
                    <div class="section-heading mb-30 wow fade-in-right" data-wow-delay="200ms">
                        ...
                        <h2 class="white">Why Ride with Short pump cab?</h2>
                    ...
                    <!--/.section-heading-->
                    <ul class="Short pump cab-features">
